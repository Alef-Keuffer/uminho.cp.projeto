...
\xymatrix@C=4cm@R=2cm{
    ...
    & \ensuremath{\Q }^*   & 1 + \ensuremath{\Q } \times \ensuremath{\Q }^* \ar[l]_{h = \ensuremath{\alt{\Varid{f}}{\Varid{g}}}}
}
\end{equation*}
\\
\\
...
\xymatrix@C=2cm@R=3cm{
    ...
    & \ensuremath{\Q }^*   & \ensuremath{\Q }^* + \ensuremath{\Q }^* \times \ensuremath{\Q }^* \ar[l]_{alg = \ensuremath{\alt{\Varid{a}}{\Varid{b}}}}
}
\end{equation*}
\newline\\
