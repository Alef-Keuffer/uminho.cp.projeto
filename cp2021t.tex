...
%
       \ensuremath{\Varid{outExpAr}\comp \underline{\Conid{X}}\mathrel{=}\Varid{id}\comp \p1}
       %
       \ensuremath{\Varid{outExpAr}\comp \Conid{N}\mathrel{=}\Varid{id}\comp \p1}
       %
       \ensuremath{\Varid{outExpAr}\comp \Conid{Bin}\mathrel{=}\Varid{id}\comp \p2\comp \p2\comp \p1}
       %
       \ensuremath{\Varid{outExpAr}\comp \uncurry{\Conid{Un}}\mathrel{=}\Varid{id}\comp \p2\comp \p2\comp \p2}
%
\just\equiv{ igualdade extensional, def-comp}
%
       \ensuremath{\Varid{outExpAr}\;\underline{\cdot }\;(\Conid{X}\;\Varid{a})\mathrel{=}\Varid{id}\comp \p1\;\Varid{a}}
       %
       \ensuremath{\Varid{outExpAr}\;\Conid{N}\;\Varid{a}\mathrel{=}\Varid{id}\comp \p1\;\Varid{a}}
       %
       \ensuremath{\Varid{outExpAr}\;\Varid{bin}\;(\Varid{op},(\Varid{l},\Varid{r}))\mathrel{=}\Varid{id}\comp \p2\comp \p2\comp \p1\;(\Varid{op},(\Varid{l},\Varid{r}))}
       %
       \ensuremath{\Varid{outExpAr}\;\uncurry{\cdot }\;\Conid{Un}\;(\Varid{op},\Varid{a})\mathrel{=}\Varid{id}\comp \p2\comp \p2\comp \p2\;(\Varid{op},\Varid{a})}
%
\just\equiv{ def const, def N, def bin, def uncurry, def Un, def-comp}
%
       \ensuremath{\Varid{outExpAr}\;\Conid{X}\;\Varid{a}\mathrel{=}\Varid{id}\mathbin{\$}\p1\;\Varid{a}}
       %
       \ensuremath{\Varid{outExpAr}\;\Conid{N}\;\Varid{a}\mathrel{=}\Varid{id}\mathbin{\$}\p1\;\Varid{a}}
       %
       \ensuremath{\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{l}\;\Varid{r})\mathrel{=}\Varid{id}\mathbin{\$}\p2\mathbin{\$}\p2\mathbin{\$}\p1\;(\Varid{op},(\Varid{l},\Varid{r}))}
       %
       \ensuremath{\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}\Varid{id}\mathbin{\$}\p2\mathbin{\$}\p2\mathbin{\$}\p2\;(\Varid{op},\Varid{a})}
%
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{clean}\;{}\<[8]%
\>[8]{}\Varid{a}\mathrel{=}(\Varid{outExpAr}\comp \Varid{h})\;\Varid{a}\;{}\<[30]%
\>[30]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\mathrel{=}\Varid{g}\;\mathbf{where}\;\Varid{g}\;(\Varid{a},\Varid{b},\Varid{c})\mathrel{=}(\Varid{a}\mathbin{*}\Varid{b}\div \Varid{c},\Varid{b}\mathbin{+}\mathrm{4},\Varid{c}\mathbin{+}\mathrm{1}){}\<[E]%
\\
...
\\
\>[B]{}\cata{\Varid{g}}\mathrel{=}\Varid{g}\comp \Varid{recL}\;\cata{\Varid{g}}\comp \Varid{outL}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\cata{\alt{\Varid{b}}{\Varid{q}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\Varid{g}}{\Varid{q}}\;\mathbf{where}{}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
