...
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\Varid{calcLine}\mathrel{=}\cata{\Varid{h}}_{[\mskip1.5mu \mskip1.5mu]}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{coalg}\mathrel{=}(\Varid{id}+(\Varid{id}+\conj{\Varid{init}}{{}\<[40]%
\>[40]{}\Varid{tail}})){}\<[49]%
\>[49]{}\comp \Varid{outSL}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{alg}\mathrel{=}\alt{\underline{\Varid{nil}}}{\Varid{a}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{a}\mathrel{=}\alt{\underline{\cdot }}{\Varid{b}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\;(\Varid{e},\Varid{d})\mathrel{=}\lambda \Varid{pt}\to (\Varid{calcLine}\;(\Varid{e}\;\Varid{pt})\;(\Varid{d}\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\;\Varid{a}\;\Varid{b}\mathrel{=}\cata{\Varid{a}}_{\mathsf{Castel}}\comp \ana{\Varid{b}}_{\mathsf{Castel}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{data}\;\mathsf{Castel}\;\Varid{a}\mathrel{=}\Conid{Empty}\mid \Conid{Single}\;\Varid{a}\mid \Conid{InitTail}\;(\mathsf{Castel}\;\Varid{a},\mathsf{Castel}\;\Varid{a})\;\mathbf{deriving}\;\Conid{Show}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}in_{\mathsf{Castel}}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\alt{\Conid{Single}}{\Conid{InitTail}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}out_{\mathsf{Castel}}\;\Conid{Empty}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}out_{\mathsf{Castel}}\;(\Conid{Single}\;\Varid{a})\mathrel{=}i_2\;(i_1\;\Varid{a}){}\<[E]%
\\
\>[B]{}out_{\mathsf{Castel}}\;(\Conid{InitTail}\;(\Varid{e},\Varid{d}))\mathrel{=}i_2\;(i_2\;(\Varid{e},\Varid{d})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}rec_{\mathsf{Castel}}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}+\Varid{f}\times\Varid{f}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\cata{\Varid{f}}_{\mathsf{Castel}}\mathrel{=}\Varid{f}\comp rec_{\mathsf{Castel}}\;\cata{\Varid{f}}_{\mathsf{Castel}}\comp {}\<[31]%
\>[31]{}out_{\mathsf{Castel}}{}\<[E]%
\\
\>[B]{}\ana{\Varid{g}}_{\mathsf{Castel}}\mathrel{=}in_{\mathsf{Castel}}\comp rec_{\mathsf{Castel}}\;\ana{\Varid{g}}_{\mathsf{Castel}}\comp \Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{center}
\xymatrix@C=3cm@R=2cm{
    & \ensuremath{\N_0}^*\ar@/^2pc/[r]^{\ensuremath{out_{\mathsf{NList}}}}\ar[d]_{\ensuremath{\cata{\alt{\Varid{b}}{\Varid{q}}}_{\mathsf{NList}}\mathrel{=}\Varid{avg\char95 aux}}} & \ensuremath{\N_0} + \ensuremath{\N_0} \times \ensuremath{\N_0}^* \ar[d]^{id + id \times \ensuremath{\cata{\alt{\Varid{b}}{\Varid{q}}}_{\mathsf{NList}}}}\ar@/^2pc/[l]^{\ensuremath{in_{\mathsf{NList}}}}  \\
...
\begin{eqnarray*}
\start
\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\alt{\Varid{b}}{\Varid{q}}}_{\mathsf{NList}}}
%
\just\equiv{ Universal-cata }
%
\ensuremath{\conj{\Varid{avg}}{\length }\comp in_{\mathsf{NList}}\mathrel{=}\alt{\Varid{b}}{\Varid{q}}\comp rec_{\mathsf{NList}}\;\conj{\Varid{avg}}{\length }}
%
\just\equiv{ Fusão-+, Absorção-+, Eq-+, Definição de \ensuremath{in_{\mathsf{NList}}}, Definição de \ensuremath{rec_{\mathsf{NList}}}}
%
\ensuremath{\begin{lcbr}\conj{\Varid{avg}}{\length }\comp \Varid{singl}\mathrel{=}\Varid{b}\comp \Varid{id}\\\conj{\Varid{avg}}{\length }\comp \Varid{cons}\mathrel{=}\Varid{q}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }\end{lcbr}}
%
\just\equiv{ Igualdade extensional, Natural-id }
%
\ensuremath{\begin{lcbr}(\conj{\Varid{avg}}{\length }\comp \Varid{singl})\;\Varid{x}\mathrel{=}\Varid{b}\;\Varid{x}\\(\conj{\Varid{avg}}{\length }\comp \Varid{cons})\;(\Varid{x},\Varid{xs})\mathrel{=}(\Varid{q}\comp \Varid{id}\times\conj{\Varid{avg}}{\length })\;(\Varid{x},\Varid{xs})\end{lcbr}}
%
\just\equiv{ Def-comp, Natural-id, Def-$\times$, Def-split, Definição de singl, Definição de cons }
%
\ensuremath{\begin{lcbr}\conj{\Varid{avg}}{\length }\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}\Varid{b}\;\Varid{x}\\\conj{\Varid{avg}}{\length }\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\Varid{q}\;(\Varid{x},(\Varid{avg}\;\Varid{xs},\length \;\Varid{xs}))\end{lcbr}}
\qed
\end{eqnarray*}
...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}in_{\mathsf{NList}}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}{}\<[E]%
\\
\>[B]{}out_{\mathsf{NList}}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}out_{\mathsf{NList}}\;(\Varid{a}\mathbin{:}\Varid{x})\mathrel{=}i_2\;(\Varid{a},\Varid{x}){}\<[E]%
\\
\>[B]{}rec_{\mathsf{NList}}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\
\>[B]{}\cata{\Varid{g}}_{\mathsf{NList}}\mathrel{=}\Varid{g}\comp rec_{\mathsf{NList}}\;\cata{\Varid{g}}_{\mathsf{NList}}\comp out_{\mathsf{NList}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\cata{\alt{\Varid{b}}{\Varid{q}}}_{\mathsf{NList}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
\begin{center}
\xymatrix@C=3cm@R=2cm{
    & LTree \ \ensuremath{\N_0}\ar@/^2pc/[r]^{\ensuremath{out_{\mathsf{LTree}}}}\ar[d]_{\ensuremath{\cata{\Varid{gene}\,}_{\mathsf{LTree}}}} & \ensuremath{\N_0} + LTree \ \ensuremath{\N_0} \times LTree \ \ensuremath{\N_0} \ar[d]^{id + \ensuremath{\cata{\Varid{gene}\,}_{\mathsf{LTree}}} \times \ensuremath{\cata{\Varid{gene}\,}_{\mathsf{LTree}}}}\ar@/^2pc/[l]^{\ensuremath{in_{\mathsf{LTree}}}}  \\
...
\begin{math}
\start
\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\Varid{gene}\,}_{\mathsf{LTree}}}
%
\just\equiv{ Universal-cata, gene = \ensuremath{\alt{\Varid{b}}{\Varid{q}}} }
%
\ensuremath{\conj{\Varid{avg}}{\length }\comp in_{\mathsf{LTree}}\mathrel{=}\alt{\Varid{b}}{\Varid{q}}\comp \Varid{recLTree}\;\conj{\Varid{avg}}{\length }}
%
\just\equiv{ Fusão-+, Absorção-+, Eq-+, Definição de inL, Definição de recLTree}
%
\ensuremath{\begin{lcbr}\conj{\Varid{avg}}{\length }\comp \Conid{Leaf}\mathrel{=}\Varid{b}\comp \Varid{id}\\\conj{\Varid{avg}}{\length }\comp \Conid{Fork}\mathrel{=}\Varid{q}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }\end{lcbr}}
%
\just\equiv{ Igualdade extensional, Natural-id }
%
\ensuremath{\begin{lcbr}(\conj{\Varid{avg}}{\length }\comp \Conid{Leaf})\;\Varid{a}\mathrel{=}\Varid{b}\;\Varid{a}\\(\conj{\Varid{avg}}{\length }\comp \Conid{Fork})\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{a})\mathrel{=}(\Varid{q}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{a})\end{lcbr}}
%
\just\equiv{ Def-comp, Natural-id, Def-$\times$, Def-split, Definição de Leaf, Definição de Fork }
%
\ensuremath{\begin{lcbr}\conj{\Varid{avg}}{\length }\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b}\;\Varid{a}\\\conj{\Varid{avg}}{\length }\;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{a}))\mathrel{=}\Varid{q}\;((\Varid{avg}\;(\mathsf{LTree}\;\Varid{a}),\length \;(\mathsf{LTree}\;\Varid{a})),(\Varid{avg}\;(\mathsf{LTree}\;\Varid{a}),\length \;(\mathsf{LTree}\;\Varid{a})))\end{lcbr}}
\qed
\end{math}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avgLTree}\mathrel{=}\p1\comp \cata{\Varid{gene}\,}_{\mathsf{LTree}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gene}\mathrel{=}\alt{\Varid{b}}{\Varid{q}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\;\Varid{a}\mathrel{=}(\Varid{a},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{q}\;((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}(((\Varid{a1}\mathbin{*}\Varid{l1})\mathbin{+}(\Varid{a2}\mathbin{*}\Varid{l2}))\mathbin{/}(\Varid{l1}\mathbin{+}\Varid{l2}),\Varid{l1}\mathbin{+}\Varid{l2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
posso definir que uma expressão $x$ do tipo \ensuremath{\mathsf{ExpAr}\;\Varid{a}} pode ser interpretada como
\ensuremath{i_1\;()} do tipo \ensuremath{\Conid{OutExpAr}\;\Varid{a}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}(\mathbin{×})\mathrel{=}(\times){}\<[E]%
\ColumnHook
\end{hscode}\resethooks


bimap de \ensuremath{\cdot +\cdot }:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\mathbf{type}\;(\mathbin{∐})\mathrel{=}\cdot +\cdot {}\<[E]%
\\
...
\\
\>[B]{}(\mathbin{∐})\mathrel{=}\alt{\cdot }{\cdot }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{BinExp}\;\Varid{d}\mathrel{=}\Conid{BinOp}\mathbin{×}\mathsf{ExpAr}\;\Varid{d}\mathbin{×}\mathsf{ExpAr}\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Note que por conta de precedência \ensuremath{\Conid{BinExp}\;\Varid{d}\mathbin{≡}\Conid{BinOp}\mathbin{×}(\mathsf{ExpAr}\;\Varid{d}\mathbin{×}\mathsf{ExpAr}\;\Varid{d})}.

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{UnExp}\;\Varid{d}\mathrel{=}\Conid{UnOp}\mathbin{×}\mathsf{ExpAr}\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Vamos criar uma interpretação de \ensuremath{\mathsf{ExpAr}\;\Varid{a}} como \ensuremath{\Conid{OutExpAr}\;\Varid{a}}.
Ou seja, essa interpretação é \ensuremath{out{_{\mathsf{ExpAr}}}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{20}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{instance}\;\Conid{Interpretation}\;(\mathsf{ExpAr}\;\Varid{a})\;(\Conid{OutExpAr}\;\Varid{a})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[17]{}){}\<[17E]%
\>[20]{}\mathrel{=}i_2\mathbin{\$}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{to}\;(\Conid{Bin}\;\Varid{op}\;\Varid{l}\;\Varid{r}){}\<[20]%
\>[20]{}\mathrel{=}i_2\mathbin{\$}i_2\mathbin{\$}i_1\;(\Varid{op},(\Varid{l},\Varid{r})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{to}\;(\Conid{Un}\;\Varid{op}\;\Varid{a}{}\<[17]%
\>[17]{}){}\<[17E]%
\>[20]{}\mathrel{=}i_2\mathbin{\$}i_2\mathbin{\$}i_2\;(\Varid{op},\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}out{_{\mathsf{ExpAr}}}\mathbin{∷}\mathsf{ExpAr}\;\Varid{a}\mathbin{→}\Conid{OutExpAr}\;\Varid{a}{}\<[E]%
\\
\>[B]{}out{_{\mathsf{ExpAr}}}\mathrel{=}\Varid{to}\mathbin{∷}\mathsf{ExpAr}\;\Varid{a}\mathbin{→}\Conid{OutExpAr}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
podemos simplificar a escrita de \ensuremath{\Varid{g\char95 eval\char95 exp}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\underline{\Varid{a}}\mathbin{∐}\Varid{id}\mathbin{∐}\Varid{ap}\comp (out_{\Conid{BinOp}}\mathbin{×}\Varid{id})\mathbin{∐}\Varid{ap}\comp (out_{\Conid{UnOp}}\mathbin{×}\Varid{id}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{33}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{clean}\mathbin{∷}(\Conid{Eq}\;\Varid{a},\Conid{Num}\;\Varid{a})\mathbin{⇒}\mathsf{ExpAr}\;\Varid{a}\mathbin{→}\Conid{OutExpAr}\;\Varid{a}{}\<[E]%
\\
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{a}{}\<[33]%
\>[33]{}\mathbin{→}out{_{\mathsf{ExpAr}}}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{tag}\mathrel{=}i_2\comp i_1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
repetia nas funções \ensuremath{\Varid{sd\char95 gen}} e \ensuremath{\Varid{ad\char95 gen}} do Tiago.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sd\char95 gen}\mathbin{∷}\Conid{Floating}\;\Varid{a}\mathbin{⇒}()\mathbin{∐}\Varid{a}\mathbin{∐}\Conid{Bin}\;(\Conid{Dup}\;(\mathsf{ExpAr}\;\Varid{a}))\mathbin{∐}\Conid{Un}\;(\Conid{Dup}\;(\mathsf{ExpAr}\;\Varid{a}))\mathbin{→}\Conid{Dup}\;(\mathsf{ExpAr}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\Varid{f}\mathbin{∐}\Varid{g}\mathbin{∐}\Varid{h}\mathbin{∐}\Varid{k}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}{}\<[8]%
\>[8]{}\mathrel{=}\underline{(\Conid{X},\Conid{N}\;\mathrm{1})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;\Varid{a}{}\<[8]%
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}{}\<[8]%
\>[8]{}\mathrel{=}\underline{(\Varid{x},\mathrm{1})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;\Varid{a}{}\<[8]%
...
Percebi que podia escrever uma função (\ensuremath{\overline{\Varid{zip}}}):
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}out_{A^{*}\times B^{*}}\mathbin{∷}[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathbin{×}[\mskip1.5mu \Varid{b}\mskip1.5mu]\mathbin{→}()+((\Varid{a}\mathbin{×}\Varid{b})\mathbin{×}([\mskip1.5mu \Varid{a}\mskip1.5mu]\mathbin{×}[\mskip1.5mu \Varid{b}\mskip1.5mu])){}\<[E]%
\\
...
\>[21]{}\mathbin{→}i_2\;((\Varid{a},\Varid{b}),(\Varid{as},\Varid{bs})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
onde $c[i] = f(a[i],b[i])$ para todo $0≤i≤\ensuremath{\Varid{min}\;(\length \;\Varid{a},\length \;\Varid{b})}$.
...
\\
\>[B]{}\Varid{zipWith'}\;\Varid{f}\mathrel{=}T_{[]}\Varid{f}\comp \Varid{zip'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{traverse}\;\Varid{f}\mathrel{=}\Varid{sequenceA}\comp T_{[]}\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Vou criar um \ensuremath{\Varid{sequenceA'}} (será uma versão menos genérica de \ensuremath{\Varid{sequenceA}}
...
\\
\>[B]{}\Varid{foldrC}\;\Varid{f}\;\Varid{u}\mathrel{=}\cata{\alt{\underline{\Varid{u}}}{\uncurry{\Varid{f}}}}_{[\mskip1.5mu \mskip1.5mu]}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{sequenceA'}\mathrel{=}\cata{\alt{\Varid{b}}{\uncurry{\Varid{g}}}}_{[\mskip1.5mu \mskip1.5mu]}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\mathrel{=}\underline{(\Varid{pure}\;[\mskip1.5mu \mskip1.5mu])}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
Sabemos que, em \ensuremath{\Conid{Applicative}\;((\mathbin{→})\;\Varid{r})}, \text{\ttfamily pure~\char61{}~const} e
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\mathrel{=}\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
A seguir seguem uma série de equivalências. Dentro de cada \text{\ttfamily \char123{}\char125{}} está uma
...
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  \ensuremath{(\comp )\;\Varid{f}\;\Varid{g}\mathrel{=}\lambda \Varid{x}\to \Varid{f}\;(\Varid{g}\;\Varid{x})}  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\Varid{sequenceA'}\comp \Varid{zipWith'}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Def-\ensuremath{\Varid{zipWith'}}  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\Varid{sequenceA'}\comp (T_{[]}\Varid{f}\comp \Varid{zip'}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}(\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\uncurry{\Varid{g}}}}_{[\mskip1.5mu \mskip1.5mu]}\comp T_{[]}\Varid{f})\comp \Varid{zip'}\;\mathbf{where}\;\Varid{g}\;\Varid{x}\;\Varid{ys}\mathrel{=}(\lambda \Varid{z}\mathbin{→}\Varid{x}\;\Varid{z}\mathbin{:}\Varid{ys}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Absorção-cata  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\uncurry{\Varid{g}}}\comp B_{[]}(\Varid{f},\Varid{id})}_{[\mskip1.5mu \mskip1.5mu]}\comp \Varid{zip'}\;\mathbf{where}\;\Varid{g}\;\Varid{x}\;\Varid{ys}\mathrel{=}(\lambda \Varid{z}\mathbin{→}\Varid{x}\;\Varid{z}\mathbin{:}\Varid{ys}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Def-baseList  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\uncurry{\Varid{g}}}\comp (\Varid{id}+\Varid{f}\mathbin{×}\Varid{id})}_{[\mskip1.5mu \mskip1.5mu]}\comp \Varid{zip'}\;\mathbf{where}\;\Varid{g}\;\Varid{x}\;\Varid{ys}\mathrel{=}(\lambda \Varid{z}\mathbin{→}\Varid{x}\;\Varid{z}\mathbin{:}\Varid{ys}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Absorção-\ensuremath{+}; Natural-const  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\uncurry{\Varid{g}}\comp (\Varid{f}\mathbin{×}\Varid{id})}}_{[\mskip1.5mu \mskip1.5mu]}\comp \Varid{zip'}\;\mathbf{where}\;\Varid{g}\;\Varid{x}\;\Varid{ys}{}\<[100]%
\>[100]{}\mathrel{=}(\lambda \Varid{z}\mathbin{→}\Varid{x}\;\Varid{z}\mathbin{:}\Varid{ys}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  \ensuremath{(\comp )\;\Varid{f}\;\Varid{g}\mathrel{=}\lambda \Varid{x}\to \Varid{f}\;(\Varid{g}\;\Varid{x})}  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\lambda (\Varid{a},\Varid{b})\mathbin{→}\uncurry{\Varid{g}}\;((\Varid{f}\mathbin{×}\Varid{id})\;(\Varid{a},\Varid{b}))}}_{[\mskip1.5mu \mskip1.5mu]}\comp \Varid{zip'}\;\mathbf{where}\;\Varid{g}\;\Varid{x}\;\Varid{ys}\mathrel{=}(\lambda \Varid{z}\mathbin{→}\Varid{x}\;\Varid{z}\mathbin{:}\Varid{ys}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Def-\ensuremath{\mathbin{×}}  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\lambda (\Varid{a},\Varid{b})\mathbin{→}\Varid{g}\;(\Varid{f}\;\Varid{a},\Varid{b})}}_{[\mskip1.5mu \mskip1.5mu]}\comp \Varid{zip'}\;\mathbf{where}\;\Varid{g}\;(\Varid{x},\Varid{ys})\mathrel{=}(\lambda \Varid{z}\mathbin{→}\Varid{x}\;\Varid{z}\mathbin{:}\Varid{ys}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\Varid{h}}}_{[\mskip1.5mu \mskip1.5mu]}\comp \Varid{zip'}\;\mathbf{where}\;\Varid{h}\;(\Varid{a},\Varid{b})\mathrel{=}(\lambda \Varid{z}\mathbin{→}(\Varid{f}\;\Varid{a})\;\Varid{z}\mathbin{:}\Varid{b}\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Def-\ensuremath{\Varid{zip'}}; Notação-\ensuremath{\lambda }  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}\cata{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\Varid{h}}}_{[\mskip1.5mu \mskip1.5mu]}\comp \ana{out_{A^{*}\times B^{*}}}_{[\mskip1.5mu \mskip1.5mu]}\;\mathbf{where}\;\Varid{h}\;(\Varid{a},\Varid{b})\;\Varid{z}\mathrel{=}(\Varid{f}\;\Varid{a})\;\Varid{z}\mathbin{:}\Varid{b}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  catamorfismo após anamorfismo é um hilomorfismo  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}{\llbracket}{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\Varid{h}},out_{A^{*}\times B^{*}}}{\rrbracket}_{[\mskip1.5mu \mskip1.5mu]}\;\mathbf{where}\;\Varid{h}\;(\Varid{a},\Varid{b})\;\Varid{z}\mathrel{=}(\Varid{f}\;\Varid{a})\;\Varid{z}\mathbin{:}\Varid{b}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{zipWithM'}\;\Varid{f}{}\<[17]%
\>[17]{}\mathrel{=}{\llbracket}{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\Varid{h}},out_{A^{*}\times B^{*}}}{\rrbracket}_{[\mskip1.5mu \mskip1.5mu]}\;\mathbf{where}\;\Varid{h}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{cons}\comp \conj{\Varid{f}\;\Varid{a}}{\Varid{b}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{calcLine}\mathrel{=}\overline{\Varid{zipWithM'}\;\uncurry{\Varid{linear1d}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  Def-\ensuremath{\Varid{zipWithM'}}  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcLine}\mathrel{=}\overline{{\llbracket}{\alt{\underline{\underline{[\mskip1.5mu \mskip1.5mu]}}}{\Varid{h}},out_{A^{*}\times B^{*}}}{\rrbracket}_{[\mskip1.5mu \mskip1.5mu]}}\;\mathbf{where}\;\Varid{h}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{cons}\comp \conj{\uncurry{\Varid{linear1d}}\;\Varid{a}}{\Varid{b}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[8]{}\mathbin{→}i_2\;(i_1\;\Varid{a}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{l}{}\<[8]%
\>[8]{}\mathbin{→}i_2\;(i_2\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{19}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}out_{\mathsf{Castel}}\mathbin{∷}\mathsf{Castel}\;\Varid{a}\mathbin{→}()\mathbin{∐}\Varid{a}\mathbin{∐}\mathsf{Castel}\;\Varid{a}\mathbin{×}\mathsf{Castel}\;\Varid{a}{}\<[E]%
\\
\>[B]{}out_{\mathsf{Castel}}\mathrel{=}\lambda \mathbf{case}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{Empty}{}\<[19]%
\>[19]{}\mathbin{→}i_1\;(){}\<[E]%
...
\>[19]{}\mathbin{→}i_2\;(i_1\;\Varid{a}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{InitTail}\;(\Varid{e},\Varid{d}){}\<[19]%
\>[19]{}\mathbin{→}i_2\;(i_2\;(\Varid{e},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}out_{\mathsf{NList}}\mathbin{∷}[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathbin{→}\Varid{a}\mathbin{∐}\Varid{a}\mathbin{×}[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}out_{\mathsf{NList}}\mathrel{=}\lambda \mathbf{case}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[9]%
\>[9]{}\mathbin{→}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}(\Varid{a}\mathbin{:}\Varid{x})\mathbin{→}i_2\;(\Varid{a},\Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
