...
\\
  ...
  \left\{
    \begin{array}{l}
                outExpAr\ .\ \ensuremath{\underline{\Conid{X}}} = id\ .\ \ensuremath{\p1}\\ 
                outExpAr\ .\ N  = id\ .\ \ensuremath{\p1} \\ 
                outExpAr\ .\ Bin  = id\ . \ \ensuremath{\p2} \ . \ \ensuremath{\p2} \ . \ \ensuremath{\p1}\\
                outExpAr\ .\ \ensuremath{\uncurry{\Conid{Un}}} = id\ .\ \ensuremath{\p2}\ .\ \ensuremath{\p2}\ .\ \ensuremath{\p2}
    \end{array}
  \right.
\end{math}
\newline\\
...
\begin{math}
  \left\{
    \begin{array}{l}
                outExpAr\ . \ \ensuremath{\underline{\Conid{X}}}\ () = \ensuremath{\p1}\ ()\\ 
                outExpAr\ .\ N \ a  =  \ensuremath{\p1} \ a \\ 
                outExpAr\ .\ Bin \  (op,(l,r))  = \ensuremath{\p2} \ . \ \ensuremath{\p2} \ . \ \ensuremath{\p1}\ (op,(l,r)) \\
                outExpAr\  .\ \ensuremath{\uncurry{\Conid{Un}}} \ (op,a) = \ensuremath{\p2}\ . \ \ensuremath{\p2} \ . \ \ensuremath{\p2} \ (op,a)
    \end{array}
  \right.
\end{math}
\newline\\
...
\begin{math}
  \left\{
    \begin{array}{l}
                outExpAr \ X  =  \ensuremath{\p1} \ ()\\ 
                outExpAr \ (N \ a) = \ensuremath{\p1} \ a \\ 
                outExpAr\ (Bin \ op \ l \  r)  = \ensuremath{\p2} \ \ensuremath{\mathbin{\$}} \ensuremath{\p2} \ \ensuremath{\mathbin{\$}} \ \ensuremath{\p1}\ (op,(l,r)) \\
                outExpAr \ (Un \ op \ a) = \ensuremath{\p2} \ \ensuremath{\mathbin{\$}} \ \ensuremath{\p2} \ \ensuremath{\mathbin{\$}} \ \ensuremath{\p2} \  (op,a)
    \end{array}
  \right.
\end{math}
\newline\\
