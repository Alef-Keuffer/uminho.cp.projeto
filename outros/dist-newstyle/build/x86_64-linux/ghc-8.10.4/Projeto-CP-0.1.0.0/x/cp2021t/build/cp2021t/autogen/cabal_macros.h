...
/* package Projeto-CP-0.1.0.0 */
#ifndef VERSION_Projeto_CP
#define VERSION_Projeto_CP "0.1.0.0"
#endif /* VERSION_Projeto_CP */
#ifndef MIN_VERSION_Projeto_CP
#define MIN_VERSION_Projeto_CP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Projeto_CP */
...
#define CURRENT_COMPONENT_ID "Projeto-CP-0.1.0.0-inplace-cp2021t"
